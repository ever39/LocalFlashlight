...
namespace LocalFlashlight
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            soundOnRecharge = Config.Bind<bool>("Time battery recharge configs", "Full battery recharge sound toggle", true, "Makes a noise when the battery fully recharges (heard by enemies if they're in range, or other players if networking is also enabled)");
