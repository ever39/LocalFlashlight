...
namespace LocalFlashlight
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            networkingWarning = Config.Bind("Networking", "Networking enabled warning", true, "Enables (or disables) the warning when the main menu is opened");
            LethalConfigManager.AddConfigItem(new BoolCheckBoxConfigItem(networkingWarning, new BoolCheckBoxOptions
            {
                RequiresRestart = false
            }));
            #endregion
            ...
            //now the base of the entire mod, since it patches most things and adds the light script to the player when they join a lobby
