...
namespace LocalFlashlight
{
    internal class LightScript : MonoBehaviour
    {
        ...
        {
            if (selectedRechargeOption != RechargeOptions.HandCranked | player_controller.quickMenuManager.isMenuOpen | player_controller.isPlayerDead | player_controller.inTerminalMenu | player_controller.isTypingChat) return;
        ...
        {
            if (selectedRechargeOption != RechargeOptions.HandCranked) return;
        ...
        void MakeLocalLight()
        {
            ...
            try
            {
                ...
                if (selectedRechargeOption == RechargeOptions.HandCranked)
                {
        ...
        void UpdateModValues()
        {
            ...
            if (selectedRechargeOption == RechargeOptions.HandCranked && dynamoAudioSource != null)
            {
        ...
        void UpdateBatteryValues()
        {
            ...
            switch (selectedRechargeOption)
            {
                ...
                case RechargeOptions.HandCranked:
                    ...
                    {
                        WindUpFlashlight();
                        windRechargeMult += Time.deltaTime * 2;
                    }
                    else if (windRechargeMult > 0)
                        windRechargeMult -= Time.deltaTime * 6;

                    batteryTime += (Time.deltaTime * batteryRegen) * windRechargeMult;
                    windRechargeMult = Mathf.Clamp(windRechargeMult, 0, 1.3f);
                    return;
